...
* ✅️ Fully supported
  ...
  Platforms that are fully supported. SCL will provide support for these platforms as much as possible.

* 🕰️ Limited support

  These platforms are usually legacy platforms.

  SCL can work on these platforms, but some features may not be available.

  We may drop some features for these platforms to reduce maintenance costs.

* 🚫 No longer supported

  The main branch of SCL no longer supports these platforms.
...
* / (Not supported)
  ...
  SCL does not support these platforms yet. We may support them in the future.
...
* 👌: Supported platforms.
  ...
  Support is provided by SCL, tested to work, but may have more problems than a fully supported platform.  
  Support for versions below Minecraft 1.6 is not guaranteed.  
  If you encounter a problem that does not exist on fully supported platforms, you can report it to SCL.

* ❔: Low-level supported platforms.

  SCL can run on this platform and has some basic support. However, launching the game directly is not yet available.  
