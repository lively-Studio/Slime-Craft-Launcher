import studio.lively.scl.gradle.ci.CheckUpdate
import studio.lively.scl.gradle.docs.UpdateDocuments
import studio.lively.scl.gradle.l10n.ParseLanguageSubtagRegistry
...
studio.lively.scl.gradle.javafx.JavaFXUtils.register(rootProject)
...
tasks.register<ParseLanguageSubtagRegistry>("parseLanguageSubtagRegistry") {
    ...
    sublanguagesFile.set(layout.projectDirectory.file("SCLCore/src/main/resources/assets/lang/sublanguages.csv"))
    defaultScriptFile.set(layout.projectDirectory.file("SCLCore/src/main/resources/assets/lang/default_script.csv"))
}
...
tasks.register<CheckUpdate>("checkUpdateDev") {
    uri.set("https://ci./job/SCL-nightly")
}

tasks.register<CheckUpdate>("checkUpdateStable") {
    uri.set("https://ci./job/SCL-stable")
}
