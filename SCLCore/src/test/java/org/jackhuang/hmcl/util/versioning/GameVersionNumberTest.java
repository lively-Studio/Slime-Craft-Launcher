 ...
 */
package studio.lively.scl.util.versioning;
...
import static studio.lively.scl.util.versioning.GameVersionNumber.asGameVersion;
import static studio.lively.scl.util.versioning.GameVersionNumber.getReleaseOfSnapshot;
...
public final class GameVersionNumberTest {
    ...
    public void testToNormalizedString() {
        ...
        assertNormalized("1.16.2-pre1", "1.16.2 Pre-release 1"); // https://github.com/SCL-dev/SCL/pull/5476
