...
public final class JsonSchemaTest {
    ...
    /// Tests reading schema strings that are not SCL schema URLs.
    @Test
    ...
    public void checksCompatibility() {
        ...
        object.addProperty(JsonSchema.PROPERTY_SCHEMA, "scl.config/3.x");
        ...
        assertEquals("scl.config/3.x", unparseable.actual().url());
