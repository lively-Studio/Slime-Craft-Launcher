...
import studio.lively.scl.download.forge.ForgeBMCLVersionList;
...
import studio.lively.scl.download.liteloader.LiteLoaderBMCLVersionList;
import studio.lively.scl.download.neoforge.NeoForgeBMCLVersionList;
...
public final class BMCLAPIDownloadProvider implements DownloadProvider {
    ...
    public BMCLAPIDownloadProvider(String apiRoot) {
        ...
        this.replacement = List.of(
                ...
                pair("https://hmcl.glavo.site/metadata/cleanroom", "https://alist.8mi.tech/d/mirror/SCL-Metadata/Auto/cleanroom"),
                pair("https://hmcl.glavo.site/metadata/fmllibs", "https://alist.8mi.tech/d/mirror/SCL-Metadata/Auto/fmllibs"),
