...
import static studio.lively.scl.download.UnsupportedInstallationException.UNSUPPORTED_LAUNCH_WRAPPER;
import static studio.lively.scl.util.StringUtils.removePrefix;
import static studio.lively.scl.util.StringUtils.removeSuffix;
