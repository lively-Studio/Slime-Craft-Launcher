...
import static studio.lively.scl.download.java.JavaPackageType.*;
import static studio.lively.scl.util.Pair.pair;
import static studio.lively.scl.util.platform.Architecture.*;
import static studio.lively.scl.util.platform.OperatingSystem.*;
