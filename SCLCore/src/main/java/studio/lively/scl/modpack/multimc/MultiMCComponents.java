...
public final class MultiMCComponents {
    ...
    static {
        ...
        // Check whether MultiMCComponents is 'studio.lively.scl.mod.multimc.MultiMCComponents'.
        ...
        if (new String(
            ...
            INSTALLER_PROFILE.put("Implementation", "Probably vanilla. Class location is not modified (studio.lively.scl.mod.multimc.MultiMCComponents).");
        } else {
