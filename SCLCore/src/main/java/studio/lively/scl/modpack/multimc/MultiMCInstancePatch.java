...
import studio.lively.scl.util.gson.JsonMap;
...
public final class MultiMCInstancePatch {
    public static final Library BOOTSTRAP_LIBRARY = new Library(new Artifact("studio.lively.scl", "mmc-bootstrap", "1.0"));
    ...
    public static ResolvedInstance resolveArtifact(List<MultiMCInstancePatch> patches, String versionID) {
        ...
        for (String trait : traits) {
            switch (trait) {
                ...
                case "texturepacks": // SCL hasn't support checking whether a game version supports texture packs.
...

        {
            ...
            jvmArguments.add(new StringArgument("-Dscl.mmc.bootstrap=" + NetworkUtils.withQuery("scl:///bootstrap_profile_v1/", Map.of(
                    "main_class", mainClass,
                    "installer", MultiMCComponents.getInstallerProfile()
            ))));
            mainClass = "studio.lively.scl.SCLMultiMCBootstrap";
        }
