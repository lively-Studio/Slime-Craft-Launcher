...
import studio.lively.scl.download.game.VersionJsonSaveTask;
import studio.lively.scl.event.*;
import studio.lively.scl.game.tlauncher.TLauncherVersion;
...
public class DefaultGameRepository implements GameRepository {
    ...
    public boolean removeVersionFromDisk(String id) {
        ...
        try {
            ...
            // remove json files first to ensure SCL will not recognize this folder as a valid version.
