 ...
 */
package studio.lively.scl.util.platform.hardware;
...
public class HardwareDetector {
    private static final boolean USE_FAST_FETCH = "true".equalsIgnoreCase(System.getProperty("scl.hardware.fastfetch", "true"));
