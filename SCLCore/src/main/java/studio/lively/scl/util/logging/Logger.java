 ...
 */
package studio.lively.scl.util.logging;
...
public final class Logger {
    ...
    static final String PACKAGE_PREFIX = "studio.lively.scl.";
    ...
    public void start(Path logFolder) {
        ...
        loggerThread.setName("SCL Logger Thread");
        loggerThread.start();

        Thread cleanerThread = new Thread(this::onExit);
        cleanerThread.setName("SCL Logger Shutdown Hook");
