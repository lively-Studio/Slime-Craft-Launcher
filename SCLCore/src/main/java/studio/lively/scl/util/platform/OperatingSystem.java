...
import studio.lively.scl.util.KeyValuePairUtils;
import studio.lively.scl.util.platform.windows.Kernel32;
...
public enum OperatingSystem {
    ...
    static {
        ...
        String hmclNativeEncoding = System.getProperty("scl.native.encoding");
