...
public final class SCLModpackManifest implements ModpackManifest {
    public static final SCLModpackManifest INSTANCE = new SCLModpackManifest();

    private SCLModpackManifest() {}

    @Override
    public ModpackProvider getProvider() {
        return SCLModpackProvider.INSTANCE;
    }
}
