...
import studio.lively.scl.launch.DefaultLauncher;
...
import studio.lively.scl.util.platform.CommandBuilder;
 ...
 */
public final class SCLGameLauncher extends DefaultLauncher {

    public SCLGameLauncher(GameRepository repository, Version version, AuthInfo authInfo, LaunchOptions options) {
        this(repository, version, authInfo, options, null);
    }

    public SCLGameLauncher(GameRepository repository, Version version, AuthInfo authInfo, LaunchOptions options, ProcessListener listener) {
        this(repository, version, authInfo, options, listener, true);
    }

    public SCLGameLauncher(GameRepository repository, Version version, AuthInfo authInfo, LaunchOptions options, ProcessListener listener, boolean daemon) {
    ...
    private Path extractLwjglUnsafeAgent() throws IOException {
        String agentVersion = JarUtils.getAttribute("scl.lwjgl-unsafe-agent.version", null);
