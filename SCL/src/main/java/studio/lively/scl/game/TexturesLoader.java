...
import studio.lively.scl.auth.offline.Skin;
import studio.lively.scl.auth.yggdrasil.*;
...
public final class TexturesLoader {
    ...
    private static final Path TEXTURES_DIR = Metadata.SCL_USER_HOME.resolve("skins");
