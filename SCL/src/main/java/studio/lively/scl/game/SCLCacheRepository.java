...
import studio.lively.scl.download.DefaultCacheRepository;

import java.nio.file.Paths;

public class SCLCacheRepository extends DefaultCacheRepository {

    private final StringProperty directory = new SimpleStringProperty();

    public SCLCacheRepository() {
    ...
    public static final SCLCacheRepository REPOSITORY = new SCLCacheRepository();
}
