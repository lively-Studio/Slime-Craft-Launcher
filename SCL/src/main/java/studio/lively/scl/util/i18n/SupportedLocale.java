...
import studio.lively.scl.util.i18n.translator.Translator;
...
public final class SupportedLocale {
    ...
    SupportedLocale() {
        ...
        String language = System.getenv("SCL_LANGUAGE");
    ...
    /// Used to represent the text display language of SCL.
    ///
    ...
    public String getDisplayName(SupportedLocale inLocale) {
        ...
        // Currently, SCL does not support any locales with regions or variants, so they are not handled for now
