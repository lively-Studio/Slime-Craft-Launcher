...
import studio.lively.scl.addon.mod.ModLoaderType;
...
public class DownloadPage extends Control implements DecoratorPage {
    ...
    private final SCLGameRepository.InstanceReference instanceReference;
    ...
    public DownloadPage(DownloadListPage page, RemoteAddon addon, SCLGameRepository.InstanceReference instanceReference, @Nullable DownloadCallback callback) {
        this.page = page;
    ...
    public SCLGameRepository.InstanceReference getInstanceReference() {
    ...
    private static class DownloadPageSkin extends SkinBase<DownloadPage> {
        ...
        protected DownloadPageSkin(DownloadPage control) {
            ...
            pane.getChildren().add(spinnerPane);
            {
                ...
                FXUtils.onChangeAndOperate(control.loaded, loaded -> {
                    ...
                    if (control.instanceReference.repository() != null && control.instanceReference.instanceId() != null) {
                        SCLGameRepository repository = control.instanceReference.repository();
            ...
            if (studio.lively.scl.util.AprilFools.isLaunchButtonPage(3)) {
    ...
    private static final class DependencyAddonItem extends LineButton {
        ...
        DependencyAddonItem(DownloadListPage page, RemoteAddon addon, SCLGameRepository.InstanceReference instanceReference) {
            this.addon = addon;
            ...
            DownloadCallback callback = switch (type) {
                case MOD -> studio.lively.scl.ui.download.DownloadPage.FOR_MOD;
                case RESOURCE_PACK -> studio.lively.scl.ui.download.DownloadPage.FOR_RESOURCE_PACK;
                case SHADER_PACK -> studio.lively.scl.ui.download.DownloadPage.FOR_SHADER;
    ...
    private static final class AddonItem extends StackPane {
        ...
        AddonItem(RemoteAddon mod, RemoteAddon.Version dataItem, DownloadPage selfPage) {
            ...
            // Workaround for https://github.com/SCL-dev/SCL/issues/2129
    ...
    public interface DownloadCallback {
        void download(DownloadProvider downloadProvider, SCLGameRepository repository, @Nullable String version, RemoteAddon addon, RemoteAddon.Version file);
    }
}
