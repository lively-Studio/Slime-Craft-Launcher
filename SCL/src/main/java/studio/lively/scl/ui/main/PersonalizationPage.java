...
import studio.lively.scl.setting.BackgroundType;
import studio.lively.scl.setting.FontManager;
import studio.lively.scl.setting.LauncherSettings;
import studio.lively.scl.setting.SettingsManager;
import studio.lively.scl.setting.ThemeColorType;
import studio.lively.scl.setting.UserSettings;
import studio.lively.scl.theme.BackgroundLoadPolicy;
import studio.lively.scl.theme.BuiltinBackground;
import studio.lively.scl.theme.NetworkBackgroundImageCachePolicy;
import studio.lively.scl.theme.Theme;
import studio.lively.scl.theme.ThemeColor;
import studio.lively.scl.theme.ThemeColorSource;
import studio.lively.scl.theme.ThemePackExporter;
import studio.lively.scl.theme.ThemePackManifest;
import studio.lively.scl.theme.ThemePackManager;
import studio.lively.scl.theme.ThemeReference;
...
import studio.lively.scl.util.javafx.SafeStringConverter;
...
public class PersonalizationPage extends StackPane {
    ...
    private void exportCurrentThemePack() {
        ...
        String defaultPackId = "com.livelystudio.scl.theme-pack." + UUIDs.toCompactString(UUIDs.generateV7(exportTimestamp));
    ...
    public PersonalizationPage() {
...

        {
...

            {
                ...
                vbox.getChildren().add(new Label("Slime Craft Launcher"));
