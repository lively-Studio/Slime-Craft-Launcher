...
import studio.lively.scl.ui.MemoryStatusBar;
import studio.lively.scl.ui.WeakListenerHolder;
import studio.lively.scl.ui.construct.LineComponent;
import studio.lively.scl.ui.construct.LineInheritableToggleButton;
import studio.lively.scl.ui.construct.RadioChoiceList;
...
import studio.lively.scl.util.platform.hardware.PhysicalMemoryStatus;
...
import static studio.lively.scl.util.DataSizeUnit.GIGABYTES;
...
final class IndependentSettingBinder {
    ...
    private static void updateMemoryStatus(
        ...
        if (Boolean.TRUE.equals(autoMemory)) {
            memoryAllocated = SCLGameRepository.getAutoAllocatedMemory(memoryStatus.available());
