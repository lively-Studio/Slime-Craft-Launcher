...
import studio.lively.scl.addon.*;
import studio.lively.scl.addon.repository.CurseForgeRemoteAddonRepository;
import studio.lively.scl.addon.mod.LocalModFile;
...
import studio.lively.scl.util.Lazy;
...
import static studio.lively.scl.ui.FXUtils.ignoreEvent;
import static studio.lively.scl.ui.FXUtils.onEscPressed;
import static studio.lively.scl.ui.ToolbarListPageSkin.createToolbarButton2;
                            ...
                            FXUtils.runInFX(() -> {
                                ...
                                button.setOnAction(e -> {
                                    ...
                                    Controllers.navigate(new DownloadPage(
                                            repository instanceof CurseForgeRemoteAddonRepository ? SCLLocalizedDownloadListPage.ofCurseForgeMod(null, false) : SCLLocalizedDownloadListPage.ofModrinthMod(null, false),
                                            remoteAddon,
                                            new SCLGameRepository.InstanceReference(ModListPageSkin.this.getSkinnable().getRepository(), ModListPageSkin.this.getSkinnable().getInstanceId()),
                                            studio.lively.scl.ui.download.DownloadPage.FOR_MOD
                                    ));
                                });
