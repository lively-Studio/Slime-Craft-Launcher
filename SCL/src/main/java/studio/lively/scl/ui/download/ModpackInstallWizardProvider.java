...
import studio.lively.scl.game.ManuallyCreatedModpackException;
...
import studio.lively.scl.modpack.UnsupportedModpackException;
...
public final class ModpackInstallWizardProvider implements WizardProvider {
    ...
    public ModpackInstallWizardProvider(SCLGameRepository repository) {
        this(repository, null, null);
    }

    public ModpackInstallWizardProvider(SCLGameRepository repository, Path modpackFile) {
        this(repository, modpackFile, null);
    }

    public ModpackInstallWizardProvider(SCLGameRepository repository, String updateVersion) {
        this(repository, null, updateVersion);
    }

    public ModpackInstallWizardProvider(SCLGameRepository repository, Path modpackFile, String updateVersion) {
