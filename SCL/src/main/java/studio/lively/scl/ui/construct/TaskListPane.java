...
import studio.lively.scl.download.cleanroom.CleanroomInstallTask;
import studio.lively.scl.download.fabric.FabricAPIInstallTask;
import studio.lively.scl.download.fabric.FabricInstallTask;
import studio.lively.scl.download.forge.ForgeNewInstallTask;
import studio.lively.scl.download.forge.ForgeOldInstallTask;
import studio.lively.scl.download.game.GameAssetDownloadTask;
import studio.lively.scl.download.game.GameInstallTask;
import studio.lively.scl.download.java.mojang.MojangJavaDownloadTask;
import studio.lively.scl.download.legacyfabric.LegacyFabricInstallTask;
import studio.lively.scl.download.liteloader.LiteLoaderInstallTask;
import studio.lively.scl.download.neoforge.NeoForgeInstallTask;
import studio.lively.scl.download.neoforge.NeoForgeOldInstallTask;
import studio.lively.scl.download.optifine.OptiFineInstallTask;
import studio.lively.scl.download.quilt.QuiltAPIInstallTask;
import studio.lively.scl.download.quilt.QuiltInstallTask;
import studio.lively.scl.game.SCLModpackInstallTask;
import studio.lively.scl.java.JavaInstallTask;
...
import studio.lively.scl.modpack.curse.CurseCompletionTask;
import studio.lively.scl.modpack.curse.CurseInstallTask;
import studio.lively.scl.modpack.mcbbs.McbbsModpackCompletionTask;
import studio.lively.scl.modpack.mcbbs.McbbsModpackExportTask;
import studio.lively.scl.modpack.modrinth.ModrinthCompletionTask;
import studio.lively.scl.modpack.modrinth.ModrinthInstallTask;
...
import studio.lively.scl.modpack.multimc.MultiMCModpackInstallTask;
import studio.lively.scl.modpack.server.ServerModpackCompletionTask;
import studio.lively.scl.modpack.server.ServerModpackExportTask;
import studio.lively.scl.modpack.server.ServerModpackLocalInstallTask;
...
import static studio.lively.scl.util.Lang.tryCast;
        ...
        executor.addTaskListener(new TaskListener() {
            ...
            public void onRunning(Task<?> task) {
                ...
                if (task instanceof GameAssetDownloadTask) {
                    ...
                    if (task.getInheritedStage() != null && task.getInheritedStage().startsWith("scl.install.game"))
                        return;
                ...
                } else if (task instanceof SCLModpackInstallTask) {
    ...
    private static final class StageNode extends Node {
        ...
        private StageNode(String stage) {
            ...
            message = switch (stageKey) {
                case "scl.modpack" ->                  i18n("install.modpack");
                case "scl.modpack.download" ->         i18n("launch.state.modpack");
                case "scl.install.assets" ->           i18n("assets.download");
                case "scl.install.libraries" ->        i18n("libraries.download");
                case "scl.install.game" ->             i18n("install.installer.install", i18n("install.installer.game") + " " + stageValue);
                case "scl.install.forge" ->            i18n("install.installer.install", i18n("install.installer.forge") + " " + stageValue);
                case "scl.install.cleanroom" ->        i18n("install.installer.install", i18n("install.installer.cleanroom") + " " + stageValue);
                case "scl.install.neoforge" ->         i18n("install.installer.install", i18n("install.installer.neoforge") + " " + stageValue);
                case "scl.install.liteloader" ->       i18n("install.installer.install", i18n("install.installer.liteloader") + " " + stageValue);
                case "scl.install.optifine" ->         i18n("install.installer.install", i18n("install.installer.optifine") + " " + stageValue);
                case "scl.install.fabric" ->           i18n("install.installer.install", i18n("install.installer.fabric") + " " + stageValue);
                case "scl.install.fabric-api" ->       i18n("install.installer.install", i18n("install.installer.fabric-api") + " " + stageValue);
                case "scl.install.legacyfabric" ->     i18n("install.installer.install", i18n("install.installer.legacyfabric") + " " + stageValue);
                case "scl.install.legacyfabric-api" -> i18n("install.installer.install", i18n("install.installer.legacyfabric-api") + " " + stageValue);
                case "scl.install.quilt" ->            i18n("install.installer.install", i18n("install.installer.quilt") + " " + stageValue);
                case "scl.install.quilt-api" ->        i18n("install.installer.install", i18n("install.installer.quilt-api") + " " + stageValue);
