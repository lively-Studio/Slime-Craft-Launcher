...
import studio.lively.scl.download.cleanroom.CleanroomRemoteVersion;
import studio.lively.scl.download.fabric.FabricAPIRemoteVersion;
import studio.lively.scl.download.fabric.FabricRemoteVersion;
import studio.lively.scl.download.forge.ForgeRemoteVersion;
import studio.lively.scl.download.game.GameRemoteVersion;
import studio.lively.scl.download.legacyfabric.LegacyFabricAPIRemoteVersion;
import studio.lively.scl.download.legacyfabric.LegacyFabricRemoteVersion;
import studio.lively.scl.download.liteloader.LiteLoaderRemoteVersion;
import studio.lively.scl.download.neoforge.NeoForgeRemoteVersion;
import studio.lively.scl.download.optifine.OptiFineRemoteVersion;
import studio.lively.scl.download.quilt.QuiltAPIRemoteVersion;
import studio.lively.scl.download.quilt.QuiltRemoteVersion;
...
import studio.lively.scl.ui.construct.RipplerContainer;
...
import studio.lively.scl.ui.wizard.Refreshable;
import studio.lively.scl.ui.wizard.WizardPage;
import studio.lively.scl.util.NativePatcher;
...
import static studio.lively.scl.ui.FXUtils.*;
