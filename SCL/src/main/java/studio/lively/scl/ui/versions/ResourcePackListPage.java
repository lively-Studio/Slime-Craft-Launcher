...
import studio.lively.scl.addon.resourcepack.ResourcePackFile;
import studio.lively.scl.addon.resourcepack.ResourcePackManager;
...
import studio.lively.scl.ui.ListPageBase;
                            ...
                            button.setOnAction(e -> {
                                ...
                                Controllers.navigate(new DownloadPage(
                                        repository instanceof CurseForgeRemoteAddonRepository
                                                ? SCLLocalizedDownloadListPage.ofCurseForgeResourcePack(null, false)
                                                : SCLLocalizedDownloadListPage.ofModrinthResourcePack(null, false),
                                        remoteAddon,
                                        new SCLGameRepository.InstanceReference(page.repository, page.instanceId),
                                        studio.lively.scl.ui.download.DownloadPage.FOR_RESOURCE_PACK
                                ));
                            });
