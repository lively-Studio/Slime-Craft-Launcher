...
import static studio.lively.scl.ui.export.ModpackTypeSelectionPage.MODPACK_TYPE;
import static studio.lively.scl.ui.export.ModpackTypeSelectionPage.MODPACK_TYPE_MODRINTH;
import static studio.lively.scl.ui.export.ModpackTypeSelectionPage.MODPACK_TYPE_SERVER;
...
public final class ModpackInfoPage extends Control implements WizardPage {
    ...
    private final SCLGameRepository gameRepository;
    ...
    public ModpackInfoPage(WizardController controller, SCLGameRepository gameRepository, String version) {
