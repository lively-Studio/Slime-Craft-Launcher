...
import static studio.lively.scl.download.RemoteVersion.Type.RELEASE;
import static studio.lively.scl.setting.SettingsManager.state;
import static studio.lively.scl.ui.FXUtils.SINE;
...
public final class MainPage extends StackPane implements DecoratorPage {
    ...
    public void initVersions(SCLGameRepository repository, List<Version> versions) {
