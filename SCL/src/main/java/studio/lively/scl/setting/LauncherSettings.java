...
public final class LauncherSettings extends ObservableSetting implements JsonSchemaSetting {
    ...
    public static final ThemeReference DEFAULT_THEME_REFERENCE = new ThemeReference("scl.default", null);
    ...
    /// Whether SCL automatically selects the number of download threads.
