...
///
/// The JSON representation is saved as `config/game-settings.json` under the current SCL
/// directory.
///
/// @author Glavo
...
public final class GameSettingsPresets extends ObservableSetting implements JsonSchemaSetting {
    ...
    public GameSettingsPresetID newPresetId() {
        GameSettingsPresetID id;
        do {
            id = GameSettingsPresetID.generate();
