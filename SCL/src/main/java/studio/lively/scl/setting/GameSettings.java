...
import studio.lively.scl.setting.property.SimpleInheritableProperty;
import studio.lively.scl.setting.property.SimpleSettingProperty;
...
import studio.lively.scl.util.gson.ObservableSetting;
...
public sealed abstract class GameSettings extends ObservableSetting {
    ...
    /// Reference to a Java runtime selected from SCL's detected Java list.
    ///
    ...
    /// If `true`, SCL will not use default JVM arguments.
    ...
    /// If `true`, SCL will not use the default optimizing JVM options.
    ...
    /// If `true`, SCL does not check JVM validity.
    ...
    /// If `true`, SCL does not check game completeness.
    ...
    /// If `true`, SCL will automatically adjust memory allocation.
    ...
    /// Property name for allowing SCL to modify the game with Java agents.
    public static final String PROPERTY_ALLOW_AUTO_AGENT = "allowAutoAgent";

    /// If `true`, SCL may attach Java agents to improve the game experience.
    ...
    /// If `true`, SCL will not generate game options automatically.
    ...
    /// If `true`, SCL does not patch native libraries.
    ...
    /// If `true`, SCL leaves native library management to the user.
    ...
    /// If `true`, SCL will use native GLFW.
    ...
    /// If `true`, SCL will use native OpenAL.
