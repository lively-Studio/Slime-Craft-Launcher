...
import studio.lively.scl.auth.authlibinjector.*;
import studio.lively.scl.auth.microsoft.MicrosoftAccount;
import studio.lively.scl.auth.microsoft.MicrosoftAccountFactory;
import studio.lively.scl.auth.microsoft.MicrosoftService;
import studio.lively.scl.auth.offline.OfflineAccount;
import studio.lively.scl.auth.offline.OfflineAccountFactory;
import studio.lively.scl.auth.yggdrasil.RemoteAuthenticationException;
import studio.lively.scl.game.OAuthServer;
...
import studio.lively.scl.util.skin.InvalidSkinException;
...
import static studio.lively.scl.setting.SettingsManager.getAccountMetadataRecords;
import static studio.lively.scl.setting.SettingsManager.getAuthlibInjectorServers;
import static studio.lively.scl.setting.SettingsManager.getUserAccountMetadataRecords;
import static studio.lively.scl.setting.SettingsManager.userSettings;
import static studio.lively.scl.ui.FXUtils.onInvalidating;
import static studio.lively.scl.util.Lang.immutableListOf;
...
public final class Accounts {
    ...
    private static AuthlibInjectorArtifactProvider createAuthlibInjectorArtifactProvider() {
        String authlibinjectorLocation = System.getProperty("scl.authlibinjector.location");
        ...
        String authlibInjectorVersion = JarUtils.getAttribute("scl.authlib-injector.version", null);
