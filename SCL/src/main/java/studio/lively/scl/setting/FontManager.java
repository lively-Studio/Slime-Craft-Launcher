...
public final class FontManager {
    ...
    private static final Lazy<Font> DEFAULT_FONT = new Lazy<>(() -> {
        ...
        font = tryLoadLocalizedFont(Metadata.SCL_LOCAL_HOME.resolve("font"));
        if (font != null)
            return font;

        font = tryLoadLocalizedFont(Metadata.SCL_USER_HOME.resolve("font"));
        if (font != null)
            return font;

        // Legacy

        font = tryLoadDefaultFont(Metadata.SCL_LOCAL_HOME);
        if (font != null)
            return font;
        ...
        font = tryLoadDefaultFont(Metadata.SCL_USER_HOME);
        if (font != null)
            return font;
    ...
    private static void updateFont() {
        ...
        if (fontFamily == null)
            fontFamily = System.getProperty("scl.font.override");
        if (fontFamily == null)
            fontFamily = System.getenv("SCL_FONT");
    ...
    // https://github.com/SCL-dev/SCL/issues/4072
